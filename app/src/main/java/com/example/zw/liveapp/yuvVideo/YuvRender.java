...
public class YuvRender implements MyEGLSurfaceView.MyGLRender {
    ...
    private YuvFboRender mYuvFboRender;
    private float[]matrix=new float[16];
    private int u_matrix;

    public YuvRender(Context context) {
        this.mContext = context;
        mYuvFboRender=new YuvFboRender(context);
    ...
    public void onSurfaceCreated() {
        mYuvFboRender.onCreate();
        String vertexShader=ShaderUtil.getRawResource(mContext, R.raw.vertex_shader_yuv);
        String fragmentShader=ShaderUtil.getRawResource(mContext,R.raw.fragment_shader_yuv);
    ...
    public void onSurfaceChanged(int width, int height) {
        ...
        mYuvFboRender.onChange(width,height);
    }
    ...
    public void onDrawFrame() {
        ...
        if(width>0 && height>0 && y!=null && u!=null && v!=null){
            ...
            GLES20.glTexImage2D(GLES20.GL_TEXTURE_2D, 0, GLES20.GL_LUMINANCE, width / 2, height / 2, 0, GLES20.GL_LUMINANCE, GLES20.GL_UNSIGNED_BYTE,
                    u);
        ...
        GLES20.glBindTexture(GLES20.GL_TEXTURE_2D, 0);
        GLES20.glBindFramebuffer(GLES20.GL_FRAMEBUFFER, 0);
        mYuvFboRender.onDraw(textureid);
    }
